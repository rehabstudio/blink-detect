...
var processor = {
  ...
  getVideoFrame: function() {
    ...
    try {
      this.outCtx.drawImage(video, (160 - (this.videoWidth/2)) * 2, (120 - (this.videoHeight/2)) * 2, this.videoWidth * 2, this.videoHeight * 2, 0, 0, this.videoWidth, this.videoHeight);
